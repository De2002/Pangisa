...
export default function ListingDetail() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--bg-warm))]">
      ...
      <div className="max-w-[1480px] mx-auto px-6 lg:px-10 py-8">
        <div className="flex items-center justify-between mb-7">
          <button
            onClick={() => navigate(-1)}
            className="group flex items-center gap-2 text-sm text-[hsl(var(--text-secondary))] hover:text-[hsl(var(--brand-primary))] transition-colors font-semibold"
          >
            <span className="flex size-8 items-center justify-center border border-[hsl(var(--border))] bg-[hsl(var(--surface-1))] group-hover:border-[hsl(var(--brand-primary))] transition-colors"><ChevronLeft className="w-4 h-4" /></span>
            Back to listings
          </button>
          <span className="hidden md:block text-[11px] font-bold uppercase tracking-[0.22em] text-[hsl(var(--text-muted))]">Pangisa / Verified rental</span>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_390px] gap-10 items-start">
          {/* Left col */}
          <div className="lg:col-span-2 space-y-6">

            {/* Photo gallery */}
            <div className="relative overflow-hidden bg-black border border-[hsl(var(--text-primary))] shadow-[0_18px_50px_-24px_hsl(var(--text-primary)/0.5)]" style={{ aspectRatio: "16/10" }}>
            ...
            <div>
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="flex-1">
                  <h1 className="text-3xl lg:text-4xl font-extrabold text-[hsl(var(--text-primary))] leading-[1.08] mb-3 text-balance tracking-[-0.035em]">{listing.title}</h1>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-5 pt-5 border-t border-[hsl(var(--border))]">
                <div className="flex items-center gap-2 px-3 py-2 bg-[hsl(var(--brand-primary))] text-white text-xs font-bold uppercase tracking-wide">
                ...
                <span className="flex items-center gap-1.5 text-xs font-semibold text-[hsl(var(--text-secondary))]"><Lock className="w-3.5 h-3.5" /> Private contact reveal</span>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-5">
              {/* Price card */}
              <div className="bg-[hsl(var(--brand-primary))] text-white p-6 border border-[hsl(var(--brand-primary-dark))] shadow-[0_20px_45px_-24px_hsl(var(--brand-primary))]">
                <div className="flex items-center justify-between mb-6">
                  <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-white/70">Secure your next home</span>
                  <ShieldCheck className="w-5 h-5 text-[hsl(var(--brand-accent-light))]" />
                </div>
                <div className="flex items-end justify-between mb-1">
                  <span className="text-4xl font-extrabold tracking-[-0.04em]">{formatUGX(listing.monthlyRent)}</span>
                  <span className="text-white/65 text-sm mb-1">/month</span>
                </div>
                {listing.deposit > 0 && (
                  <p className="text-xs text-white/65 mb-5">Deposit: {formatUGX(listing.deposit)} <span className="text-white/40">· refundable terms apply</span></p>
                )}
                <AvailabilityBadge lastConfirmedAt={listing.lastConfirmedAt} availableUnits={listing.availableUnits}
              ...
              {/* Landlord card */}
              <div className="bg-[hsl(var(--surface-1))] p-6 border border-[hsl(var(--border))] shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-[11px] font-bold text-[hsl(var(--text-muted))] uppercase tracking-[0.18em]">Listed by</h3>
                  <span className="flex items-center gap-1 text-[11px] font-bold uppercase tracking-wide text-[hsl(var(--brand-primary))]"><ShieldCheck className="w-3.5 h-3.5" /> Trusted</span>
                </div>
